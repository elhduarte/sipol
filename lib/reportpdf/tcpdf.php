...
class TCPDF {
 ...
 $this->Image('images/logo_puntos.jpg',10,10,55);
			   $this->Image('images/pncbw.JPG',180,5,25);
			  // $this->Image($_SESSION['qr'],180,5,25);
			   $this->SetFont('Courier','',10);
			   $this->Cell(184,22,'POLICIA NACIONAL CIVIL',0,0,'C');
			   $this->Ln(5);
			   $this->Cell(184,24,'GUATEMALA',0,0,'C');
			   $this->Ln(5);
			   $this->Cell(184,26,$_SESSION['entidad'],0,0,'C');
			   $this->Ln(5);
			   $this->Cell(184,28,$_SESSION['sede'],0,0,'C');
	...
	protected function setFooter() {
		...
		if ($this->print_footer) {
		 ...
		 $this->SetY(-15);
			...
			$a=TCPDF_STATIC::$alias_tot_pages;

					
		    $this->Cell(0,0,('Pagina '.$this->PageNo().'/'.$a),0,0,'C');
		    $hora_bruta = date("H:i:s",time());
		    $this->Ln(3);
		   ;
		    $this->Cell(40,0, (date('d/m/Y')."  ".$hora_bruta),0,1,'L');
