...
public function obtenerConsultasPorEvento($fechaIniGral4, $fechaFinGral4, $tipo_evento, $estado)
		{
			...
			$condicion.=' and e.fecha_ingreso  BETWEEN '.$fechaIniGral4.' and '.$fechaFinGral4;
				$SQL="SELECT 
							en.id_cat_entidad, en.nombre_entidad entidad, count(e.*) 
						FROM
							sipol.tbl_evento e, 
						...
						where 
						  ...
						  AND e.ID_USUARIO IN (SELECT ID_USUARIO FROM SIPOL_USUARIO.TBL_ROL_USUARIO WHERE ID_ROL =7)
						  AND en.id_cat_entidad not in(1)
...
public function obtenerConsultasPorEvento2($fechaIniGral4, $fechaFinGral4, $tipo_evento, $estado,$id_cat_entidad)
		{
			...
			$condicion.=' and e.fecha_ingreso BETWEEN '.$fechaIniGral4.' and '.$fechaFinGral4;
			  	...
			  	$SQL1="SELECT 
							en.id_cat_entidad, en.nombre_entidad entidad, count(e.*), s.nombre sede 
						FROM
							sipol.tbl_evento e, 
						    catalogos_publicos.tbl_sede s, 
						    catalogos_publicos.cat_entidad en, 
			  ...
			  //echo $SQL1;
			  //Yii::log('ii', CLogger::LEVEL_ERROR, $SQL1);
...
{	
$query = "SELECT nombre FROM catalogos_publicos.tbl_sede 
...
return $resultado;
		...
		public function getConteoSede($id_cat_entidad,$id_hecho_denuncia,$tiposede,$sedes)
	{
$condicion_tiposede ="";
if($tiposede ==00)
{
	...
	$condicion_tiposede ="and ts.id_tipo_sede=".$tiposede;
}
$condicion_sedes ="";
if($sedes ==00)
{
	...
	$condicion_sedes ="and ts.id_sede=".$sedes;
}
...
return $resultado;
		...
		public function getSumaSede($id_cat_entidad,$id_hecho_denuncia,$tiposede,$sedes)
	{
...
public function getConteoSede2($id_cat_entidad,$id_hecho_denuncia,$fechainicio,$fechafin)
	{

$query = "SELECT ts.id_sede,ts.nombre,count(*) FROM sipol.tbl_evento e, sipol.tbl_evento_detalle ed, catalogos_publicos.tbl_sede ts, catalogos_publicos.cat_entidad ce
 where ed.fecha_evento  BETWEEN '".$fechainicio."' AND '".$fechafin."'
and e.estado = 't' 
and ed.id_evento = e.id_evento
and ce.id_cat_entidad = ts.id_cat_entidad
and ts.id_sede = e.id_sede
...
return $resultado;
		...
		public function getSumaSede2($id_cat_entidad,$id_hecho_denuncia,$fechainicio,$fechafin)
	{
...
return $resultado;
	...
	public function getGrid2($idsede,$idhecho,$fechainicio,$fechafin)
	{
 ...
 ";
	$connection=Yii::app()->db;
			...
			foreach($dataReader as $row)
		{
			...
			$fecha_ingreso = 
            $fecha1 = date("d-m-Y",strtotime($fecha_ingreso));

            $hora_ingreso = str_replace('{','', $hora_ingreso);
            $hora_ingreso = str_replace('}','', $hora_ingreso);
