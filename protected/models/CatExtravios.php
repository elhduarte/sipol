...
/**
 * This is the model class for table "sipol_catalogos.cat_extravios".
 *
 * The followings are the available columns in table 'sipol_catalogos.cat_extravios':
 * @property integer $id_extravio
 * @property string $nombre_extravio
 * @property string $h1
 * @property string $h2
 * @property string $h3
 * @property string $h4
 ...
 * @property string $h50
 */
class CatExtravios extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CatExtravios the static model class
	 */
	...
	{
		return 'sipol_catalogos.cat_extravios';
	}
	...
	public function rules()
	{
		...
		return array(
			array('nombre_extravio', 'required'),
			...
			array('id_extravio, nombre_extravio, h1, h2, h3, h4, h5, h6, h7, h8, h9, h10, h11, h12, h13, h14, h15, h16, h17, h18, h19, h20, h21, h22, h23, h24, h25, h26, h27, h28, h29, h30, h31, h32, h33, h34, h35, h36, h37, h38, h39, h40, h41, h42, h43, h44, h45, h46, h47, h48, h49, h50', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'id_extravio' => 'Id Extravio',
			'nombre_extravio' => 'Nombre Extravio',
			'h1' => 'H1',
			'h2' => 'H2',
			'h3' => 'H3',
			'h4' => 'H4',
	...
	public function search()
	{
		...
		$criteria->compare('id_extravio',$this->id_extravio);
		$criteria->compare('nombre_extravio',$this->nombre_extravio,true);
