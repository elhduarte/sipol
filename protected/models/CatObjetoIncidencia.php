...
/**
 * This is the model class for table "sipol_catalogos.cat_objeto_incidencia".
 *
 * The followings are the available columns in table 'sipol_catalogos.cat_objeto_incidencia':
 * @property integer $id_objeto_incidencia
 ...
 * @property string $h50
 */
class CatObjetoIncidencia extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CatObjetoIncidencia the static model class
	 */
	...
	{
		return 'sipol_catalogos.cat_objeto_incidencia';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_objeto_incidencia, nombre_objeto, h1, h2, h3, h4, h5, h6, h7, h8, h9, h10, h11, h12, h13, h14, h15, h16, h17, h18, h19, h20, h21, h22, h23, h24, h25, h26, h27, h28, h29, h30, h31, h32, h33, h34, h35, h36, h37, h38, h39, h40, h41, h42, h43, h44, h45, h46, h47, h48, h49, h50', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'id_objeto_incidencia' => 'Id Objeto Incidencia',
	...
	public function search()
	{
		...
		$criteria->compare('id_objeto_incidencia',$this->id_objeto_incidencia);
		$criteria->compare('nombre_objeto',$this->nombre_objeto,true);
	...
	public function getObjetos()
	{
		...
		$criterio->order ='nombre_objeto ASC';

	    $data =  CHtml::listData($this->findAll($criterio), 'id_objeto_incidencia','nombre_objeto');
