...
/**
 * This is the model class for table "sipol_catalogos.cat_consignados".
 *
 * The followings are the available columns in table 'sipol_catalogos.cat_consignados':
 * @property integer $id_cat_consignados
 * @property string $nombre_consignado
 * @property string $h1
 * @property string $h2
 * @property string $h3
 * @property string $h4
 ...
 * @property string $h50
 */
class CatConsignados extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CatConsignados the static model class
	 */
	...
	{
		return 'sipol_catalogos.cat_consignados';
	}
	...
	public function rules()
	{
		...
		return array(
			array('nombre_consignado', 'required'),
			...
			array('id_cat_consignados, nombre_consignado, h1, h2, h3, h4, h5, h6, h7, h8, h9, h10, h11, h12, h13, h14, h15, h16, h17, h18, h19, h20, h21, h22, h23, h24, h25, h26, h27, h28, h29, h30, h31, h32, h33, h34, h35, h36, h37, h38, h39, h40, h41, h42, h43, h44, h45, h46, h47, h48, h49, h50', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'id_cat_consignados' => 'Id Cat Consignados',
			'nombre_consignado' => 'Nombre Consignado',
			'h1' => 'H1',
			'h2' => 'H2',
			'h3' => 'H3',
			'h4' => 'H4',
	...
	public function search()
	{
		...
		$criteria->compare('id_cat_consignados',$this->id_cat_consignados);
		$criteria->compare('nombre_consignado',$this->nombre_consignado,true);
	...
	public function getConsignados()
	{
		$devuelve = "";
		$contador = 0;
		$filtro = new CDbCriteria;
		$filtro->order = "nombre_consignado ASC";

		$datos = CHtml::listData($this->findAll($filtro),'id_cat_consignados','nombre_consignado');

		foreach ($datos as $key => $value) {
			
			if($contador == '0'){
				$devuelve = CHtml::tag('option', array('value'=>'','style'=>'display:none;'),CHtml::encode('Seleccione un tipo de Consignado'),true);
