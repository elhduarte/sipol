...
<style>
  ...
  <div style ="padding-top : 1%; padding-right : 2%;" class=" pull-right">
    <label >
        <input id="buscar_evento" type="checkbox"> Deseo buscar un número de evento especifico
      </label>
  </div>

<div style="padding-bottom:2%; display:none; " class="cuerpo-small form-inline" id="por_evento" >
    <h4>Número de Evento</h4>
    <hr>
    <input type="text" class="span4" id="input_evento_num">
    <button type="button" class="btn btn-primary" id="filtrar_evento_num">Buscar</button>
</div>
...
<div class="row-fluid">
  <div class="span12">
    ...
    <div class="row-fluid">
      <div class="span12">
        <legend style="margin-bottom: 2%;"><img style="" src="images/icons/glyphicons_156_show_thumbnails.png"  alt=""> Administrador De Eventos
            <div  class="pull-right">
          <label class="radio inline radioInline">
          <input type="radio" id ="tipo" name="tipo" value="1" checked> Denuncia
          </label>
          <label class="radio inline radioInline">
          <input type="radio" id ="tipo" name="tipo" value="2"> Incidencia
          </label>
          <label class="radio inline radioInline">
          <input type="radio" id ="tipo" name="tipo" value="3">Extravio
          </label>
            </div>
        </legend>     
      </div>
    ...
    <label class ="campotit">Tipo de Hecho</label>
      ...
      <div class="span3">
       <label class ="campotit">Hechos</label>
            <select class ="span12" name="cmb_hecho" id="cmb_hecho">
            <?php
            $Criteria = new CDbCriteria();
            $Criteria->order ='id_hecho_denuncia ASC';
