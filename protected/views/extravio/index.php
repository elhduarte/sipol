...
<div class="modal" id="modal_cargando">
    <div class="modal-body">
      <h4><img  height ='30px'  width='30px' src='images/loading.gif' style="padding:10px;"/>El ingreso de Extravío está cargando...</h4>
    </div>
</div>

<h3 style="text-align:center; margin-top:0px; margin-right:5px; line-height:40px;">Ingreso de Extravío</h3>

<div class="well well-small form-inline" style="display:none;">
  <label for="identificador_denuncia" class="campotit" style="margin:5px;">ID Extravío </label>
  <input type="text" id="identificador_denuncia" value="empty" readonly>
  <label for="denX" class="campotit" style="margin:5px;">denX </label>
  <input type="text" id="denX" value="0" readonly>
  <label for="ubiX" class="campotit" style="margin:5px;">ubiX </label>
  <input type="text" id="ubiX" value="0" readonly>
  <label for="detX" class="campotit" style="margin:5px;">detX </label>
  <input type="text" id="detX" value="0" readonly>
  <label for="relX" class="campotit" style="margin:5px;">relX </label>
  <input type="text" id="relX" value="0" readonly>
</div>
  ...
  <div class="tabbable tabs-left">
    <ul class="nav nav-tabs" id="nav_denuncia">
      <li class="active" data-toggle="tooltip" data-placement="right" title= <?php echo $tt_denunciante; ?> id="dli_denunciante">
        <a href="#tab1" data-toggle="tab"><i class="icon-user" style="margin-right:10px;"></i> Ciudadano</a> </li>
      ...
      <li class="disabled" data-toggle="tooltip" data-placement="right" title= <?php echo $tt_hechos; ?> id="dli_hechos">
        <a id="aTab3" href="javascript: void(0)" data-toggle="tab"><i id="i_hechos" class="icon-th-list BotonClose" style="margin-right:10px;"></i> Objetos Extraviados</a></li>
