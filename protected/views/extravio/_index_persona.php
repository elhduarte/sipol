...
<form id="select_renap" action='<?php echo Yii::app()->createUrl('Extravio/Procesa_renap'); ?>'>
	<div class="well">
			...
			<div class="span2">
				...
				<center>
					<div class="row-fluid">
						...
						<div class="span7">
							<button type="submit" class="btn btn-primary span12 searchPersonaBtn" id="renap_buscar_btn"><i class="icon-search icon-white"></i> Buscar</button>
						</div>
					</div>
				</center>
			</div>
	...
	$('#select_renap').submit(function(e){
		...
		if(dpi == '')
		{
			...
			else
			{
				llamada = $.ajax({
					type: 'POST',
					url: "<?php echo Yii::app()->createUrl('Extravio/Procesa_renap'); ?>",
					data:
