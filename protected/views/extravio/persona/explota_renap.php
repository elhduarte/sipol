		...
		<div id="datos_contacto">
			<div class="row-fluid">
				<div class="span2">
					...
					<input id="r_telefono_cnt" title="Ingresa un numero de telefono valido, sin guiones ni espacios. Ej:45678912" class="span12" type="text" placeholder="Teléfono de contacto" pattern="[0-9]{8}">
				</div>
				<div class="span2">
					<p class="campotit">Email</p>
					<input id="r_email_cnt" title="correo@email.com" class="span12" type="email" placeholder="Email de Contacto">
				</div>
				<div class="span2">
...
$(document).ready(function(){
	...
	saveDenunciante = function(datos_asociacion,explotados_renap,caracteristicas_fisicas,datos_contacto,llave_clean,cui_clean,foto_clean,idEvento,email)
	{
		$.ajax({
			type: 'POST',
			url: '<?php echo Yii::app()->createUrl("Extravio/Save_denunciante"); ?>',
			data: 
			{
