...
<div class="row-fluid">
  <div class="span12">
    <div class="row-fluid">
      ...
      <div class="span2">
       <center>
      	<a href="index.php?r=Estadisticascf/altomando" role="button" class="btn btn-large btn-success" data-toggle="modal" style="margin-top: 11%;" ><i class=" icon-arrow-left icon-white"></i> Ir al Menu </a>
    ...
    var comisaria =$('#idcomisaria').val();
      ...
      }else if(boton5 == "btn btn-large btn-danger eventodia")
      {
        ...
        $('#boton1').addClass("btn btn-large btn-danger eventodia");   
  	      ...
  	      $.ajax({
        type:'POST',
        url:'<?php echo CController::createUrl("Estadisticascf/comisariafiltrosweb"); ?>',
        data:{
 ...
 $("#boton1").click(function() {
  ...
  $('#generargraficasubmit').submit(function(){
    ...
    $('#boton1').addClass("btn btn-large btn-danger eventodia");  
      ...
      $.ajax({
        type:'POST',
        url:'<?php echo CController::createUrl("Estadisticascf/MapaGeneral"); ?>',
        data:{
          tipoevento:tipoevento,
          tiposede:tiposede,
          sedes:sedes,
