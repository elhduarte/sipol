...
function llamarhoy($id_hecho,$comisariaentrada)
{
	...
	and ts.id_cat_entidad = ".$comisariaentrada."
...
function llamarayer($id_hecho,$comisariaentrada)
{
	$querydos ="SELECT count(ed.id_evento) as conteo
	FROM sipol.tbl_evento_detalle ed
	INNER JOIN sipol.tbl_evento e ON ed.id_evento = e.id_evento
...
function llamarunasemana($id_hecho,$comisariaentrada)
{
	$querydos ="SELECT count(ed.id_evento) as conteo
	FROM sipol.tbl_evento_detalle ed
	INNER JOIN sipol.tbl_evento e ON ed.id_evento = e.id_evento
...
function llamardossemana($id_hecho,$comisariaentrada)
{
	$querydos ="SELECT count(ed.id_evento) as conteo
	FROM sipol.tbl_evento_detalle ed
	INNER JOIN sipol.tbl_evento e ON ed.id_evento = e.id_evento
...
function llamarunmes($id_hecho,$comisariaentrada)
{
	$querydos ="SELECT count(ed.id_evento) as conteo
	FROM sipol.tbl_evento_detalle ed
	INNER JOIN sipol.tbl_evento e ON ed.id_evento = e.id_evento
...
function llamarmesanterior($id_hecho,$comisariaentrada)
{
	$querydos ="SELECT count(ed.id_evento) as conteo
	FROM sipol.tbl_evento_detalle ed
	INNER JOIN sipol.tbl_evento e ON ed.id_evento = e.id_evento
...
function procesafila($nombrehecho,$id_hecho,$comisariaentrada,$contador,$objPHPExcel)
{
	$hoy = llamarhoy($id_hecho,$comisariaentrada);
	$ayer = llamarayer($id_hecho,$comisariaentrada);
	$unasaemana = llamarunasemana($id_hecho,$comisariaentrada);
	$dossemanas = llamardossemana($id_hecho,$comisariaentrada);
	$unmes = llamarunmes($id_hecho,$comisariaentrada);
	$mesanterior = llamarmesanterior($id_hecho,$comisariaentrada);
...
foreach ($resultado as $key => $value) {
	procesafila($value['nombre_denuncia'],$value['id_cat_denuncia'],$comisariaentrada,$contador,$objPHPExcel);
	$contador = $contador +1;
}
$variable_datos_usuario = json_decode($_SESSION['ID_ROL_SIPOL']);
