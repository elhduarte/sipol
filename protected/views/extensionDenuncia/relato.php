...
<legend style="margin-bottom: 0px;">Relato del Evento</legend> 
      ...
      <div id="editor" style="margin-bottom:0.5%;" class="color"></div>
...
$(document).ready(function(){
  ...
  $('#SaveRelato').click(function(){
    ...
    var id_denuncia = "<?php echo $idEvento;?>";
    ...
    else
    {
      ...
      var objetosjson = "[{";
        ...
        $.ajax({
          type:'POST',
          url:'<?php echo CController::createUrl("ExtensionDenuncia/SaveRelato"); ?>',
          data:{
                relato:relato,
                objetos:objetosjson,
          ...
          success: function(respuesta)
          {
            ...
            $('#nuevoIdEvento').val(respuesta);
            $(this).actualizaResumen();
            $('#aextHechos').attr('href','#extHechos');
            $('#iextHechos').removeClass('BotonClose');
            $('#liextHechos').removeClass('disabled');
            $('#aextCommit').attr('href', '#extCommit');
            $('#iextCommit').removeClass('BotonClose');
            $('#liextCommit').removeClass('disabled');
            $('#aextHechos').click();
            //$('#confirmarExtension').removeAttr('disabled');
          },
        });
      }
