...
<div class="cuerpo">
  ...
  <div class="well well-small form-inline" hidden>
    ...
    <input type="text" id="identificador_incidencia" value="empty" readonly>
    <label for="tipX" class="campotit" style="margin:5px;">tipX </label>
    <input type="text" id="tipX" value="0" readonly class="input-small">
    <label for="AgeX" class="campotit" style="margin:5px;">AgeX </label>
    <input type="text" id="AgeX" value="0" readonly class="input-small">
    <label for="ubiX" class="campotit" style="margin:5px;">ubiX </label>
    <input type="text" id="ubiX" value="0" readonly class="input-small">
    <label for="relX" class="campotit" style="margin:5px;">relX </label>
    <input type="text" id="relX" value="0" readonly class="input-small">
    <label for="conX" class="campotit" style="margin:5px;">conX </label>
    <input type="text" id="conX" value="0" readonly class="input-small">
  </div>
  ...
  <div class="tabbable tabs-left">
    <ul class="nav nav-tabs" id="nav_incidencia">
      <li class="active" data-toggle="tooltip" data-placement="right" title= <?php echo $tt_tipo; ?> id="ili_tipoM">
        <a href="#tab1" data-toggle="tab"><i class="icon-flag" style="margin-right:10px;"></i> Tipo y Motivo</a> 
  	</li>
      <li class="disabled" data-toggle="tooltip" data-placement="right" title= <?php echo $tt_agente; ?> id="ili_agentes">
        <a id="aTab2" href="javascript: void(0)" data-toggle="tab"><i id="i_agentes" class="icon-user BotonClose" style="margin-right:10px;"></i> Agentes Implicados</a>
    	</li>
      ...
      <li class="disabled" data-toggle="tooltip" data-placement="right" title= <?php echo $tt_consignados; ?> id="ili_consigna">
        <a id="aTab5" href="javascript: void(0)" data-toggle="tab"><i id="i_consignaciones" class="icon-asterisk BotonClose" style="margin-right:10px;"></i> Consignaciones</a>
    	</li>
    	<li class="disabled" data-toggle="tooltip" data-placement="right" title= <?php echo $tt_resumen; ?> id="ili_resumen">
        <a id="aTab6" href="javascript: void(0)" data-toggle="tab"><i id="i_resumen" class="icon-print BotonClose" style="margin-right:10px;"></i> Resumen del Evento</a>
    	</li>
    </ul>
    <div class="tab-content">
      ...
      <div class="tab-pane active" id="tab1">
      	<div class="accordion-inner">
        	<?php //$this->renderPartial('_tipoymotivo'); ?>
        </div>
      </div>
