			...
			<div class="span10">
				...
				<div class="row-fluid">
					<div class="span3">
						...
						<input type="text" class="span12" id="AG_nacimiento" <?php echo $readonly;?> value="<?php echo $nacimiento; ?>" nombre="Nacimiento">	
					</div>
					<div class="span3">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#addAgente').submit(function(e){
			...
			var idIncidencia = $('#identificador_consignacion').val();
			...
			$.ajax({
				type:'POST',
				url:'<?php echo Yii::app()->createUrl("Consignacion/AddAgente");?>',
				data:
				{
				...
				success:function(respuesta)
				{
					...
					$('#cli_ubicacion').attr('class','enabled');
