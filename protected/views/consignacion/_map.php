...
<?php
//$geoserver = 'http://192.168.253.247/geoserver/';
$geoserver = 'https://geoserver.mingob.gob.gt/geoserver/';
//$geoserver = '/geoserver/';
?>
<div class="well">
...
<label title="Marcar Punto" for="radio1"><img class ="m_punto" width="10px" height="20px" src="images/icons/glyphicons_238_pin.png"/></label>
<input style ="margin: 10px;" type="radio" id="radio2" name="radio" value="zoomin" onclick="toggleControl(this);" /><label title="" for="radio2"><img class ="acercar" width="20px" height="20px" src="images/icons/glyphicons_236_zoom_in.png"/></label>
<input  style ="margin: 10px;" type="radio" id="radio3" name="radio" value="zoomout" onclick="toggleControl(this);" /><label title="" for="radio3"><img class ="alejar" width="20px" height="20px" src="images/icons/glyphicons_237_zoom_out.png"/></label>
<input style ="margin: 10px;" type="radio" id="radio4" name="radio" value="navigation" onclick="toggleControl(this);" /><label title="" for="radio4"><img class ="mover" width="20px" height="20px" src="images/icons/glyphicons_186_move.png"/></label>
...
$(document).ready(function(){
  ...
  $('#cmb_mupio').tooltip({title:'Seleccione Un Municipio'});
  $('#geo_zona').tooltip({title:'Ingrese la Zona Donde Ocurrio El Hecho'});
  $('#geo_colonia').tooltip({title:'Ingrese Colonia Donde Ocurrio El Hecho'});
  $('#geo_diereccion').tooltip({title:'Ingrese Dirección Donde Ocurrio EL Hecho'});
  $('#geo_referencia').tooltip({title:'Ingrese la Referencia Donde Ocurrio El Hecho'});
  $('#map').tooltip({title:'Click En El Lugar Donde Ocurrio el Hecho'});
  $('.m_punto').tooltip({title:'Marcar Punto'});
  $('.acercar').tooltip({title:'Zomm In (+)'});
  $('.alejar').tooltip({title:'Zoom Out (-)'});
  $('.mover').tooltip({title:'Mover Mapa'});
