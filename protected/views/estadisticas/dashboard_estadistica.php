...
<div class="row-fluid cuerpo">
  <div class="span12">
     <h3>SIPOL Dashboard Estatus 
        <button id="aniocinco" class="btn btn-small btn-primary pull-right"  style="margin-left: 0.5%;" type="button">2015</button> 
        <button id="aniocuatro" class="btn btn-small  pull-right"  style="margin-left: 0.5%;" type="button">2014</button> 
...
$(document).ready(function(){
 // Enviodatos();
  $("#aniocinco").click(function() {
    $('#aniocinco').removeClass(); 
    $('#aniocinco').addClass("btn btn-small btn-primary pull-right");   
  ...
  $("#aniocuatro").click(function() {
    ...
    $('#aniocinco').removeClass();  
    $('#aniocinco').addClass("btn btn-small  pull-right");
    $('#aniotres').removeClass();  
    $('#aniotres').addClass("btn btn-small  pull-right"); 
    Enviodatos();
  });//fin de la funcion de click para el boton de 1 mes
