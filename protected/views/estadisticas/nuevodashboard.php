...
<div id="filtros" name ="filtros" class="row-fluid cuerpo">
  <div class="span12">
    <legend>Informacíon de la Comisaria: <?php echo $variable_datos_usuario[0]->nombre_entidad?></legend>
    <div class="row-fluid">
...
$('#gomenu').click(function(){
  ...
  urlmenu = '<?php echo CController::createUrl("Estadisticas/Index"); ?>';
...
$('#envioporcorreomodaltablaglobal').click(function(){
  var tiempo = "";
    ...
    var correo =$('#correoelectronicoglobal').val();
      $.ajax({
        type:'POST',
        url:'<?php echo CController::createUrl("Estadisticas/Correoenviotablaglobal"); ?>',
        data:{
...
$('#envioporcorreo').click(function(){
  var tiempo = "";
    ...
    var correo =$('#correoelectronico').val();
      ...
      $.ajax({
        type:'POST',
        url:'<?php echo CController::createUrl("Estadisticas/Correoenviotabla"); ?>',
        data:{
          tipoevento:tipoevento,
          tiposede:tiposede,
          sedes:sedes,
...
actualizaSede(entidad,tipo_sede);
    ...
    var comisaria =$('#idcomisaria').val();
      $.ajax({
        type:'POST',
        url:'<?php echo CController::createUrl("Estadisticas/Cuadroglobal"); ?>',
        data:{
          tipoevento:tipoevento,
          comisaria:comisaria
        },
...
$('#generargraficasubmit').submit(function(){
    ...
    var comisaria =$('#idcomisaria').val();
      $.ajax({
        type:'POST',
        url:'<?php echo CController::createUrl("Estadisticas/tabaldashoboarsede"); ?>',
        data:{
          tipoevento:tipoevento,
          tiposede:tiposede,
          sedes:sedes,
