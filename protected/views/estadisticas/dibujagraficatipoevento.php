<div id="correorespuesta2"> </div>
<div "respuestaajax2"> </div> 
                        ...
                        events: {
                            click: function() {
                                ...
                                if (drilldown) { // drill down
                                    ...
                                    var fechainicio= "<?php echo $fechaIniGral4;?>";
                                    var fechafin = "<?php echo $fechaFinGral4;?>";
                                    var comisaria = drilldown.name; 
                                     //alert(comisaria);
                                        $.ajax({
                                            url: '<?php echo Yii::app()->createUrl("Estadisticas/tablacomisaria"); ?>',
                                            type: 'POST',
                                            data: {
                                            ...
                                            $("#tabla").html(response);
                                            /*$('#primernivel').html('');
                                            $('#primernivel').html(response);
                                            $('#segundonivel').html('');
                                            $('#segundonivel').html(response);*/
                                            // $('#container').show(1000);
                                            }
                                        });//fin del ajax
