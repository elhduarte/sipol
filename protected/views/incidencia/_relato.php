  ...
  $(document).ready(function(){
    ...
    fnSaveRelato = function(who){
      ...
      else
      {
        ...
        $.ajax({
          type:'POST',
          url:'<?php echo CController::createUrl("Incidencia/SaveRelato"); ?>',
          data:{
                relato:relato,
          ...
          success: function(respuesta)
          {
            if(who !== 'general'){
              ...
              $('#ili_personas').attr('class','enabled');
              $('#i_personas').removeClass('BotonClose');
              ...
              $('#tab4').hide(50);
              $('#tab5').show(50);
              $('#nav_incidencia li:eq(4) a').tab('show');
            }
