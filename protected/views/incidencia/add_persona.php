...
<div id="contentPersonRela" hidden>
  <div class="well" id="hecho_prin" style="margin-bottom:40px;">
  <input type="text" id="IdsPersonasApart" class="span4" style="display:none;">
    <form id="form_calidad_juridica" style="margin-bottom:0px;">
      ...
      <div class="row-fluid">
        <div class="span3 offset1">
          <label class="campotit3" for="estadoFisico">Estado Físico</label>
        </div>
        <div class="span5">
          <select class="span12" id="estadoFisico" required>
