<?php 
 ...
 $idusuario = $model->id_usuario; 
  ...
  $variableusuario = $compilar->compilarget("'".$idusuario."'");
   $cartausuario = $variableusuario;
...
//Yii::log('', CLogger::LEVEL_ERROR, $sqlconteo);
...
//Yii::log('', CLogger::LEVEL_ERROR, $sqlsistema);
       ...
       ?>
           ...
           <div class="span2  ">
            ...
            <div class="span2 ">
					...
					<?php echo validarcampo($fecha_nacimiento); ?>
					</p>        
            </div>
             <div class="span2 ">
            		<p>
...
<div class="row-fluid">
 ...
 <h4><img style="" src="images/icons/glyphicons_089_building.png" class="" alt=""> Información Del Sistema </h4>
 <hr>
      	 <div class="row-fluid">
          <div class="span2">
          	<p>
        ...
        <hr>
          ...
          <?php echo "<a href='index.php?r=tblUsuario/view&id=".$id_usuario_crea."'>".$sistemanombre_completo."</a>"; ?>				
				</p>           	
           </div>   
           <div class="span2">
           	  	<p>
 ...
 <hr>
  ...
  <div class="row-fluid">
  <div class="span12 cuerpo">
  	 <h4><img style="" src="images/icons/glyphicons_040_stats.png"  alt=""> Grafica de Ingreso Sistema </h4>
...
<br>
  <div class="row-fluid">
  <div class="span12 cuerpo">
  	 <h4><img style="" src="images/icons/glyphicons_353_nameplate_alt.png" class="" alt=""> Usuarios a su Cargo </h4>
  	 <?php 
			/*$model=new TblUsuario;
			$this->renderPartial('ver_grid',array(
			'model'=>$model,'id'=>$idusuario,
			));*/
	?>  
    </div>
  </div>
