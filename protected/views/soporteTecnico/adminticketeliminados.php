...
<div class="row-fluid">
  <div class="span12">
<legend><img src="images/icons/glyphicons_244_conversation.png" alt=""> Historial de Ticket Desactivados <img id="resfres" class="pull-right" src="images/icons/glyphicons_229_retweet_2.png" style="height: auto; max-width: 3%; padding-bottom: 50px; " alt=""></legend> 
...
ti.fecha_elimnado as fechaticket, 
ti.hora_eliminado as horaticket,  
pi.nombre_prioridad as prioridad, 
ti.inconveniente as titulo ,
ti.telefono as telefono
from 
soporte_aplicaciones.tbl_ticket_delete ti,
...
order by ti.id_ticket desc,  ti.fecha_elimnado desc
";
...
echo '<td><a href="index.php?r=soporteTecnico/chateliminados&par='.$chatencriptado.'" target="_new"><button class="btn btn-mini btn-primary" type="button">Chat</button></a></td>';
echo '</tr>';
			}
