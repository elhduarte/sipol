...
class CatEntidadController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','getentidad'),
				'users'=>array('@'),
			),
		...
		public function actionGetEntidad()
			{
				...
				if($_POST['region']== '0' || $_POST['region'] == 'Todos')
				{
					$Criteria->condition = '';

				}else{
					$Criteria->condition = "region='".$_POST['region']."'";
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['CatEntidad']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_cat_entidad));
		}
